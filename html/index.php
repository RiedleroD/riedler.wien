...
<body>
	...
	<div class="slant">
		...
		<fieldset>
			...
			<?php
				genHeBiLink(rwicon("yt"),"Youtube","https://www.youtube.com/channel/UC0aIZx6FIHB5Fq_sr0TMXSw");
				genHeBiLink(rwicon("lmms"),"LMMS Sharing Platform","https://lmms.io/lsp/?action=browse&user=Riedler");
				genHeBiLink(rwicon("lbry"),"LBRY","lbry://@Riedler:6");
				genHeBiLink(rwicon("oy"),"Odysee","https://odysee.com/@Riedler:6");
				genHeBiLink(rwicon("npstr"),"Napster","https://at.napster.com/artist/riedler");
				genHeBiLink(rwicon("bl"),"BandLab","https://bandlab.com/riedler");
				genHeBiLink(rwicon("sy"),"Spotify","https://open.spotify.com/artist/7k9sRjqYP68ZI8Bw8BwmuG");
				genHeBiLink(rwicon("ht"),"Hearthis","https://hearthis.at/riedler/");
				genHeBiLink(rwicon("bp"),"Boomplay","https://www.boomplay.com/artists/19145926");
				genHeBiLink(rwicon("az"),"Amazon","https://www.amazon.com/s?k=Riedler&i=digital-music&search-type=ss");
				genHeBiLink(rwicon("am"),"Amazon Music","https://music.amazon.com/artists/B08QG41MYN/riedler");
				genHeBiLink(rwicon("ih"),"iHeart","https://www.iheart.com/artist/riedler-36682916/");
				genHeBiLink(rwicon("sc"),"SoundCloud","https://soundcloud.com/riedler-music");
				genHeBiLink(rwicon("apm"),"Apple Music","https://music.apple.com/gb/artist/riedler/1544612571");
				genHeBiLink(rwicon("yx"),"Yandex Music","https://music.yandex.com/artist/10521437");
				...
				genHeBiLink(rwicon("vn"),"Vibe/Naver","https://vibe.naver.com/artist/4810478");
			?>
		</fieldset>
		<fieldset>
